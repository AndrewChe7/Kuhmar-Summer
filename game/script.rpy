...
label prologue2:
    ...
    scene bg d_front
    "Потом мы пошли в корпус D. Там была столовка, танцы и bg 3d Графика."
    scene bg 3d
    "Я записался на bg 3d графику, ее вел Сасаткин"
    scene bg food
...
label day1:
    ...
    with fade
    menu:
        "Далее я мог выбрать между bg 3d Графикой и Музыкой."
        "Пойти на bg 3d графику":
            scene bg 3d
            show zhenya
            with fade
            "Я пошёл на кафедру bg 3d и встретил там Женю."
            zhenya "Привет"
            k "Шалом!"
            "Мы с ней провели весь день на bg 3d. Мы даже не обращали внимания на препода и саму кафедру. Мы обсуждали наши жизни часами напролёт."
